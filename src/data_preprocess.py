...
def init_args():
    ...
    parser.add_argument("--train_dir", default="./data/small_train", type=str)
    parser.add_argument("--val_dir", default="./data/small_dev", type=str)
...
if __name__ == "__main__":
    ...
    print('Parse news')
    parse_news(path.join(args.test_dir, 'news.tsv'),
               path.join(args.test_dir, 'news_parsed.tsv'),
               path.join(args.train_dir, 'category2int.tsv'),
               path.join(args.train_dir, 'word2int.tsv'),
               path.join(args.train_dir, 'entity2int.tsv'),
               mode='test')
